				...
				<fieldset>
					...
					<p>
						<form:label for="equityAllocation" path="equityAllocation"
							cssErrorClass="error">Equity Allocation</form:label>
						<br />
					...
					<p>
						<form:label for="renewalDate" path="renewalDate"
							cssErrorClass="error">Renewal Date</form:label>
						<br />
	...
	<div id="popup" style="display: none;">
		<div class="span-8 last">
			...
			<form>
				<fieldset>
					<p>
						<label for="assignedId">Assigned Id</label><br /> <input
							id="assignedId" type="text" readonly="readonly" />
					</p>
					<p>
						<label for="confirmedName">Name</label><br /> <input
							id="confirmedName" type="text" readonly="readonly" />
					</p>
					<p>
						<label for="confirmedBalance">Balance</label><br /> <input
							id="confirmedBalance" type="text" readonly="readonly" />
					</p>
					<p>
						<label for="confirmedRenewalDate">Renewal Date</label><br /> <input
							id="confirmedRenewalDate" type="text" readonly="readonly" />
					</p>
				</fieldset>
			</form>
