...
public class AccountJsonBindingTests extends TestCase {
  ...
  private String testPayload =
      "{\"name\":\"jim\",\"id\":null,\"balance\":\"$1,000.00\",\"equityAllocation\":\"60%\",\"renewalDate\":\"1/22/11\"}";

  @Override
  public void setUp() {
    FormattingConversionServiceFactoryBean factoryBean =
  ...
  public void testAnnotationDrivenJsonConversion() throws Exception {
    ...
    assertEquals("Incoming and outgoing JSON representations expected to match", testPayload,
